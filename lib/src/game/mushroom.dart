    ...
    with HasGameRef<PixelAdventure>, CollisionCallbacks
{
  ...
  {
    return SpriteAnimation.fromFrameData(game.images.fromCache('Enemies/Mushroom/$state (32x32).png'),
  ...
  void _movement(dt)
  {
    ...
    {
      targetDirection =
      (player2.x + player2Offset < position.x + mushroomOffset) ? -1 : 1;
      velocity.x = targetDirection * runSpeed;
    }
