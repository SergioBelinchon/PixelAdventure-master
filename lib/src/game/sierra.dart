...
class Sierra extends SpriteAnimationComponent with HasGameRef<PixelAdventure>
{
  ...
  static const double sierraSpeed = 0.03;
  ...
  void update(double dt)
  {
    if(esVertical)
      {
        _moveVerticalmente(dt);
      }
    else
      {
        _moveHorizontalmente(dt);
      }

    super.update(dt);
  }

  void _moveVerticalmente(double dt)
  {
  ...
  void _moveHorizontalmente(double dt)
  {
